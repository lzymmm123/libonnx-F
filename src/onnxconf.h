 ...
 * Macro
 */
#define min(a, b)			({__typeof(a) _amin = (a); __typeof(b) _bmin = (b); (void)(&_amin == &_bmin); _amin < _bmin ? _amin : _bmin;})
#define max(a, b)			({__typeof(a) _amax = (a); __typeof(b) _bmax = (b); (void)(&_amax == &_bmax); _amax > _bmax ? _amax : _bmax;})
